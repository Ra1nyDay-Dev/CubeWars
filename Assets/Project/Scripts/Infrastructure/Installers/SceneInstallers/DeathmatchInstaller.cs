...
{
    public class DeathmatchInstaller : MonoInstaller, IInitializable
    {
        ...
        public void Initialize() => 
            Container.Resolve<DeathmatchBootstrap>().PrepareGame();

        private void BindBootstrapServices()
        {
            Container.BindInterfacesTo<DeathmatchInstaller>().FromInstance(this).AsSingle();
            Container.Bind<DeathmatchBootstrap>().AsSingle();
        }
